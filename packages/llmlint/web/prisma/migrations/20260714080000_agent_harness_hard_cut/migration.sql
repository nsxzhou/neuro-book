...
INSERT INTO "new_AgentInvocation" ("callerJson", "createdAt", "error", "errorJson", "finishedAt", "id", "inputJson", "mode", "pendingApprovalsJson", "phase", "profileKey", "resultJson", "retryOf", "sessionId", "status", "terminationReason", "turns") SELECT "callerJson", "createdAt", "error", "errorJson", "finishedAt", "id", "inputJson", "mode", "pendingApprovalsJson", "phase", "profileKey", "resultJson", "retryOf", "sessionId", "status", CASE WHEN "status" = 'completed' THEN 'tool_terminate' ELSE NULL END, "turns" FROM "AgentInvocation";
